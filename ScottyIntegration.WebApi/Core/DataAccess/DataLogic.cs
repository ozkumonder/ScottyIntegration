...
namespace ScottyIntegration.WebApi.Core.DataAccess
{
    public class DataLogic
    {
        ...
        //public static List<FicheDatas> GetProductionFiches()
        //{
        //    var result = new List<FicheDatas>();
        //    string sql = @"SELECT id,ficheType,ficheData FROM BTI_PRT_OLDJSON WHERE ficheType = 'productionFiche' AND ficheData NOT LIKE '%serviceName%' ORDER BY id";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => new FicheDatas
        //    {
        //        Id = s.Field<int>("id"),
        //        FicheType = s.Field<string>("ficheType"),
        //        FicheData = s.Field<string>("ficheData"),
        //    }).ToList();

        //    return result;
        //}
        //public static List<FicheDatas> GetConsumeFiches()
        //{
        //    var result = new List<FicheDatas>();
        //    string sql = @"SELECT id,ficheType,ficheData FROM BTI_PRT_OLDJSON WHERE ficheType = 'consumeFiche' AND ficheData NOT LIKE '%serviceName%' ORDER BY id";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => new FicheDatas
        //    {
        //        Id = s.Field<int>("id"),
        //        FicheType = s.Field<string>("ficheType"),
        ...
        //    return result;
        //}
        //public static List<FicheDatas> GetWasteFiches()
        //{
        //    var result = new List<FicheDatas>();
        //    string sql = @"SELECT id,ficheType,ficheData FROM BTI_PRT_OLDJSON WHERE ficheType = 'wasteFiche' AND ficheData NOT LIKE '%serviceName%' ORDER BY id";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => new FicheDatas
        //    {
        //        Id = s.Field<int>("id"),
        //        FicheType = s.Field<string>("ficheType"),
        ...
        //    return result;
        //}
        //public static List<FicheDatas> GetSalesFiches()
        //{
        //    var result = new List<FicheDatas>();
        //    string sql = @"SELECT id,ficheType,ficheData FROM BTI_PRT_OLDJSON WHERE ficheType = 'salesFiche' AND ficheData NOT LIKE '%serviceName%' ORDER BY id";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => new FicheDatas
        //    {
        //        Id = s.Field<int>("id"),
        //        FicheType = s.Field<string>("ficheType"),
        ...
        //    return result;
        //}
        //public static List<FicheDatas> GetTreatFiches()
        //{
        //    var result = new List<FicheDatas>();
        //    string sql = @"SELECT id,ficheType,ficheData FROM BTI_PRT_OLDJSON WHERE ficheType = 'treatFiche' AND ficheData NOT LIKE '%serviceName%' ORDER BY id";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => new FicheDatas
        //    {
        //        Id = s.Field<int>("id"),
        //        FicheType = s.Field<string>("ficheType"),
        ...
        //{
        //    var result = string.Empty;
        //    string sql = @"SELECT acessToken FROM BTI_PRT_ERPLOGINDATA WHERE erpId = 2";
        //    result = _dataAccess.GetDataTable(sql, ref exception).AsEnumerable().Select(s => s.Field<string>("acessToken"))
        //        .FirstOrDefault();
        //    return result;
        //}
